    ...
    case "aboutme":
      return (
        <div>
            ...
            <p>
            I AM MIRKAN KILIC
AND THIS IS HOW I STARTED PROGRAMMING

   Hello. My name is Mirkan, I am 24 years old, and I am from Izmir, east coast of Turkey. I live in New Orleans with an authorized working permit
...
My SoloLearn account(I made some applications for fun here when I first started to learn): https://www.sololearn.com/Profile/4488642
      ...
      case "mycertificates":
        return (
          ...
          <p>Solo learn: https://sololearn.com/Profile/4488642</p>
          <p>corserea: https://www.coursera.org/?authMode=login</p>
          <p>freecodecamp: https://learn.freecodecamp.org/</p>
            </div>)
      default:
        return (
          <div>
